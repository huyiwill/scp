...
class AdminPage {
	...
	private function pageList() {
		...
		$_pagelist .= '<li class="active"><a style="color:#fff;" href="javascript:void(0)">'.$this->_page.'</a></li>';
	...
	private function next() {
		...
		return ' <li><a href="'.url($this->_url,$this->url($this->_page+1)).'" data-toggle="tooltip" data-placement="top" title="下一页" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></a> ';
	}
	//尾页
