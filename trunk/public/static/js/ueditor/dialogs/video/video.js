...
(function(){
    ...
    function convert_url(url){
        ...
        url = utils.trim(url)
			...
			.replace(/v\.qq\.com\/x\/cover\/[\w]+\/[\w]+\/([\w]+)\.html/i, "v.qq.com/iframe/player.html?vid=$1&tiny=0&auto=0")
	...
	*/
	...
	function convert_url(url){
        ...
        url = utils.trim(url)
			...
			.replace(/v\.qq\.com\/x\/cover\/([\w\-=]+)\/([\w\-=]+)\.html/i, "v.qq.com/iframe/player.html?vid=$2&tiny=0&auto=0");
